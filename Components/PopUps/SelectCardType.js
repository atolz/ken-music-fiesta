...
const SelectCardType = ({ onSelectCardType, onCancel }) => {
  ...
  const handleChange = (event) => {
    ...
    console.log("chane is ", event.target.value);
  };
  return (
    <div>
      {" "}
        ...
        <div className="popup-box">
          ...
          <div className="grid sidebar:grid-flow-col gap-[1.6rem] mb-[5rem]">
            <div className="rounded-[2rem] bg-white min-h-[12.1rem] px-[2rem] mobile:px-[4.1rem] py-[2rem] relative flex items-center justify-between default-shadow">
              <FormControlLabel
                value="top"
                control={<Radio onChange={handleChange} checked={selectedValue === "Kennis Card"} value="Kennis Card" name="radio-buttons" inputProps={{ "aria-label": "Kennis Card" }} />}
                label={
                  <>
            ...
            <div className="rounded-[2rem] bg-white min-h-[12.1rem] px-[2rem] mobile:px-[4.1rem] py-[2rem] relative flex items-center justify-between  default-shadow overflow-hidden ">
              <FormControlLabel
                value="top"
                control={
                  <Radio
                ...
                label={
                  <>
                    ...
                    <span className=" block font-medium text-[2.4rem] text-[#747474] leading-[2.2rem] mr-[3rem] ml-[10rem] mobile:ml-[9rem]  max-w-[7.1rem] mobile:max-w-[14rem] whitespace-nowrap overflow-hidden text-ellipsis mobile:whitespace-normal">
