...
const LandingPage = () => {
  ...
  return (
    <Container>
      <div>
        <span className={` font-bold text-[1.6rem] landing_868:text-[2.5rem] leading-[3rem]  text-grad mb-[1.6rem] landing_868:mb-[.4rem] ${styles.slide_up_now} inline-block `}>22nd Edition</span>
        ...
        <p
          className={` font-normal text-[1.4rem] landing_868:text-[1.6rem] leading-[2rem] landing_868:leading-[2.6rem] text-white mt-[2.4rem] landing_868:mt-[1.4rem] mb-[5.5rem] max-w-[58.7rem]  ${styles.slide_up_now_2}`}
        >
