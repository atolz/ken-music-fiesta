  ...
  return (
    <>
      ...
      <div className="py-[6.1rem] px-[2.9rem] sidebar:px-[5.9rem]  bg-party rounded-[2rem] bg-cover bg-slate-900 flex flex-col items-start h-max">
        ...
        <h3 className="mb-[1.92rem] font-bold text-[3.4rem] sidebar:text-[4.4rem] max-w-[408px] text-[#FAFAFA] leading-[4.8rem] block">Kennis Music Fiesta</h3>
        <p className="mb-[4.2rem] font-normal text-[1.4rem] max-w-[27rem] leading-[2rem] text-[#FAFAFA]">No Event.</p>
        {/* <p className="mb-[4.2rem] font-normal text-[1.4rem] max-w-[27rem] leading-[2rem] text-[#FAFAFA]">Get your ticket for the event and book your spot to the most exciting event.</p> */}
        <button
          onClick={() => {
            // popUpFunctions.initBuyTicket();
            // dispatch(setActivePage("Events"));
          }}
          className="btn btn--outlined text-white !border-white mb-[4.8rem] cursor-not-allowed"
        >
          Buy Event Ticket
        </button>
