...
const BaseLayout = ({ children }) => {
  ...
  return (
    <div className="w-full h-screen flex">
      ...
      {getLocalStorage("section") == "Artiste" && <ArtisteSideBar activePage={activePage} setActivePage={setActivePage}></ArtisteSideBar>}
      ...
      <main className={"bg-[#FBFAFA] h-full flex-grow px-[2.2rem] !pb-[11.4rem] sidebar:pb-[5.2rem] sidebar:px-[5.2rem] py-[1.4rem]  sidebar:py-[4.4rem] overflow-y-scroll scroll_hide"}>
        <Container>
          ...
          {getLocalStorage("section") == "Artiste" && <ArtisteHeader title={activePage} setActivePage={setActivePage}></ArtisteHeader>}
