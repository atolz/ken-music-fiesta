    ...
    <Popup footer={false}>
      <div className="grid place-items-center px-6 relative">
        ...
        <div className="p-[2.5rem] !border-2 grid place-items-center rounded-primary w-[25.6rem] mt-[2.7rem] mb-[2.4rem] gradient-border-bg">
          <img className="p-1 rounded-[1rem] border-2 border-dashed" src="/qr-code.png"></img>
        </div>
        <div className="rounded-[1rem] bg-[#F6EBF5] grid place-items-center h-[6.2rem] px-[2rem] text-[1.7rem] text-primary font-bold mb-8">XW25Y5XQKBL2FUUVUEMQ</div>
      </div>
    </Popup>
  );
};
