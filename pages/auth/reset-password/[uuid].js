...
const ResetPassword = () => {
  ...
  const onResetPassword = async () => {
    ...
    try {
      ...
      if (error.response && error.response.data.message[0].includes("password")) {
      ...
      {active == "form" && (
        <div className="auth-container !mb-[10rem]">
          ...
          >
            ...
            <p className="mb-[3.4rem]">You are almost there, just a few little details and we are good. Already a member? Sign In</p>
            ...
            <div className="grid grid-cols-2 gap-5 gap-y-[2.4rem]">
              ...
              <button onClick={() => {}} className="btn col-span-2 mt-[4.8rem]">
                Continue
              </button>
            </div>
          </form>
